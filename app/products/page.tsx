    ...
    >
      <div style={{ position: "relative", height: 160, overflow: "hidden", background: "var(--green-pale)" }}>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: "rgba(255,255,255,0.9)" }}>
            {product.category}
          </span>
        </div>
      </div>
      <div style={{ padding: "1rem", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto" }}>
          <div style={{ fontFamily: "var(--font-display)", fontSize: "1.2rem", fontWeight: 900, color: "var(--green-dark)" }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 400, color: "var(--gray-mid)" }}> /{product.unit}</span>
          </div>
          <button
    ...
    <>
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 300, display: "flex" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, background: "white", width: 280, padding: "1.5rem", overflowY: "auto", boxShadow: "var(--shadow-lg)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
              ...
              <button onClick={() => setSidebarOpen(false)} style={{ background: "none", border: "none", fontSize: 22, cursor: "pointer", color: "var(--gray-mid)" }}>×</button>
            </div>
      ...
      <div style={{ background: "linear-gradient(135deg, var(--green-dark) 0%, var(--green-mid) 100%)", padding: "3rem 2rem" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          {error && <p style={{ marginTop: "0.5rem", fontSize: 13, color: "var(--red-cross)", background: "var(--red-light)", padding: "6px 12px", borderRadius: 6, display: "inline-block" }}>⚠️ {error}</p>}
        </div>
      </div>
